...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    url: "https://www.lifestudio.com",    siteName: "Life Flowers Studio",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1771579037483-z9kji4b2.mp4",        alt: "Luxurious bouquet of fresh, vibrant flowers."},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1771579037483-z9kji4b2.mp4"],
  },
  robots: {
    index: true,
    follow: true,
