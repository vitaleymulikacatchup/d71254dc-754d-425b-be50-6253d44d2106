...
export const metadata: Metadata = {
  title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",  description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",  keywords: ["flowers", "floral studio", "bouquet", "arrangements", "gifts", "weddings", "events", "flower delivery", "Life Flowers Studio", "fresh flowers"],
  openGraph: {
    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    url: "https://www.lifestudio.com",    siteName: "Life Flowers Studio",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1771680143093-eezdue7y.mp4",        alt: "Luxurious bouquet of fresh, vibrant flowers."},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1771680143093-eezdue7y.mp4"],
  },
  robots: {
    index: true,
    follow: true,
