...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    url: "https://www.lifestudio.com",    siteName: "Life Flowers Studio",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/elegant-rose-bouquet_23-2147697781.jpg",        alt: "Luxurious bouquet of fresh, vibrant flowers."},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Life Flowers Studio - Fresh Floral Arrangements & Gifts",    description: "Discover exquisite floral arrangements, gifts, and event services from Life Flowers Studio. Handcrafted bouquets for every occasion. Order fresh flowers online.",    images: ["https://img.b2bpic.net/free-photo/elegant-rose-bouquet_23-2147697781.jpg"],
  },
  robots: {
    index: true,
    follow: true,
